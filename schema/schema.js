...
const Passengers = [
    ...
    { name: "Priyanka Yadav", age: 26, luggage: { carry: true, number: 1, type: "Suitcase", weight: 20 },  id: "1", flightId: "1" },
    { name: "Ekansh", age: 20, luggage: { carry: false, number: 0, type: "null", weight: 0 },  id: "2" , flightId: "2" },
    { name: "vijay Laxmi Yadav", age: 50, luggage: { carry: false, number: 0, type: "null", weight: 0 },  id: "3" , flightId: "1" },
    { name: "Ashok Kumar Yadav", age: 52, luggage: { carry: true, number: 3, type: "Briefcase", weight: 10 },  id: "4" , flightId: "3" },
    { name: "Ashok Kumar Yadav", age: 52, luggage: { carry: true, number: 3, type: "Briefcase", weight: 10 },  id: "5" , flightId: "2" }
]
...
const RootQuery = new GraphQLObjectType({
    ...
    fields: {
        flight: {
            ...
            resolve(parent, args){
                // code to get flight from database.
